...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('homecss/assets/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('homecss/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">

    <!-- Fonts -->
    <link href="{{ asset('homecss/assets/https://fonts.googleapis.com') }}" rel="preconnect">
    <link href="{{ asset('homecss/assets/https://fonts.gstatic.com') }}'" rel="preconnect" crossorigin>
    <link
        href="{{ asset('homecss/assets/https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Raleway:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap') }}"
        rel="stylesheet">

    <!-- Vendor CSS Files -->
    <link href="{{ asset('homecss/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('homecss/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('homecss/assets/vendor/aos/aos.css') }}" rel="stylesheet">
    <link href="{{ asset('homecss/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('homecss/assets//vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">

    <!-- Main CSS File -->
    <link href="{{ asset('homecss/assets/css/main.css') }}" rel="stylesheet">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <h1 class="sitename">Fauzi Rettob</h1>
            </a>
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <img src="{{ asset('homecss/assets/img/hero-bg.jpg') }}" alt="" data-aos="fade-in">
            ...
            <div class="container">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-xl-5 img-bg" data-aos="fade-up" data-aos-delay="100">
                        <img src="{{ asset('homecss/assets/img/why-us-bg.jpg') }}" alt="">
                    </div>
        ...
        <section id="call-to-action" class="call-to-action section dark-background">
            ...
            <img src="{{asset('homecss/assets/img/cta-bg.jpg')}}" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 position-relative" data-aos="zoom-out" data-aos-delay="200">
                        <div class="phone-wrap">
                            <img src="{{asset('homecss/assets/img/iphone.png')}}" alt="Image" class="img-fluid">
                        </div>
                    </div>
                </div>
    ...
    <footer id="footer" class="footer light-background">
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-5 col-md-12 footer-about">
                        <a href="index.html" class="logo d-flex align-items-center">
                            <span class="sitename">Fauzi Rettob</span>
                        </a>
        ...
        <div class="container copyright text-center">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">Fauzi Rettob</strong> <span>All Rights Reserved</span>
            </p>
            <div class="credits">
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('homecss/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('homecss/assets/vendor/php-email-form/validate.js') }}"></script>
    <script src="{{ asset('homecss/assets/vendor/aos/aos.js') }}"></script>
    <script src="{{ asset('homecss/assets/vendor/glightbox/js/glightbox.min.js') }}"></script>
    <script src="{{ asset('homecss/assets/vendor/swiper/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('homecss/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js') }}"></script>
    <script src="{{ asset('homecss/assets/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>

    <!-- Main JS File -->
    <script src="{{ asset('homecss/assets/js/main.js') }}"></script>
